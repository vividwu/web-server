package com.vivid.framework.web.privilege.config.db;
...
@MapperScan(basePackages = {"com.vivid.framework.web.privilege.mapper"}, sqlSessionTemplateRef = "dbSqlSessionTemplate")
public class DatabaseConfig {
    ...
    public SqlSessionFactory dbSqlSessionFactory(@Qualifier("dbDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:com/vivid/framework/web/privilege/mapper/*.xml"));
